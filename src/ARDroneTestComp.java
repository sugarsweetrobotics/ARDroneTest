...
/*!
 * @class ARDroneTestComp
 * @brief Standalone component Class
 *
 */
public class ARDroneTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(ARDroneTest.component_conf);
      mgr.registerFactory(prop, new ARDroneTest(), new ARDroneTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("ARDroneTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        ARDroneTestComp init = new ARDroneTestComp();
